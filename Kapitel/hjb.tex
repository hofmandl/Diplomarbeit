...
\begin{myDefinition} 
\standardsatz
Wir bezeichnen mit $X_{\tau,\pi}$ die Lösung der von $\tau$ und $\pi$ kontrollierten Vermögensgleichung.
\begin{align*}
...
\begin{equation*}
 X_{\tau,\pi}(t) = X_{\pi}(t) \left( 1 - \Indikatorfunktion_{\left[\tau,T\right]} \pi(\tau) k \right)
\end{equation*} 
Der Prozess  $X_{\tau,\pi}$ folgt also im wesentlichen der Dynamik im crasfreien Scenario; vor dem Crash sind sie gleich, nach dem Crash unterscheiden sie sich um einen
Faktor. Insbesondere gilt:
\begin{equation}
 X_{\tau,\pi}(\tau) = X_{\pi}(\tau) \left( 1 - \pi(\tau) k \right) = X_{\tau, \pi}(\tau-) \left( 1 - \pi(\tau) k \right)
\end{equation} 

Im folgenden geben wir noch einem oft benötigten Operator einen Namen.
\begin{myDefinition} 
\standardsatz
